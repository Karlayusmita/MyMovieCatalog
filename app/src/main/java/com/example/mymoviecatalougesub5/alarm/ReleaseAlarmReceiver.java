...
public class ReleaseAlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String title = context.getString(R.string.pref_release_Title);
        String movieName = intent.getStringExtra(INTENT_TITLE);
        Log.e("notificationId", title);
        showAlarmNotification(context, title, notificationId, movieName);
    }

    private void showAlarmNotification(Context context, String title, int notification, String movieName) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setContentText(String.format(context.getString(R.string.notification_message), movieName))
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            ...
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL, "NOTIFICATION+CHANNEL_NAME", importance);
    ...
    public void setRepeatingAlarm(Context context, List<Movie> movies) {
        ...
        Toast.makeText(context, context.getText(R.string.message_set_release_alarm), Toast.LENGTH_SHORT).show();
    }
